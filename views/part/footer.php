...
<![endif]-->
		...
		$('#id-input-file-3').ace_file_input({
			...
			console.log($(this).data('input_files'));
			//console.log($(this).data('input_method'));
		});
		...
		try{
			...
			tag_input.after('<textarea id="'+tag_input.attr('id')+'" name="'+tag_input.attr('name')+'" rows="6">'+tag_input.val()+'</textarea>').remove();
			//autosize($('#form-field-tags'));
		}

		//cita-cita
		var tag_input = $('#form-field-cita');
		try{
			tag_input.tag(
			  {
				placeholder:tag_input.attr('placeholder'),
			...
			//programmatically add/remove a tag
			var $tag_obj = $('#form-field-cita').data('tag');
			$tag_obj.add('Menjadi pengusaha');
		...
		//anggota
		//cita-cita
		var tag_input = $('#form-field-anggota');
		try{
			tag_input.tag(
			  {
				placeholder:tag_input.attr('placeholder'),
			...
			//programmatically add/remove a tag
			var $tag_obj = $('#form-field-anggota').data('tag');
			$tag_obj.add('Notulen');
