                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        foreach ($question as $row) {
                            ...
                            if (isset($row->quiz) && ($row->quiz>0)) {
                                echo "<a data-toggle='modal' href='#modal_quiz_$no'><label><font color='green'>$no. $row->question</font></label> <i class='ace-icon fa fa-pencil bigger-140'></i></a><br>";
                            } else {
                                echo "<a data-toggle='modal' href='#modal_quiz_$no'><label><font color='red'>$no. $row->question</font></label> <i class='ace-icon fa fa-pencil bigger-140'></i></a><br>";
                            }
            ...
            jQuery(function($) {
                ...
                $(document).one('ajaxloadstart.page', function(e) {
                    ...
                    $('.daterangepicker.dropdown-menu,.colorpicker.dropdown-menu,.bootstrap-datetimepicker-widget.dropdown-menu').remove();
                        ...
                        <div class="modal fade" id="modal_quiz_<?php echo $no;?>" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php if (isset($row->observasi) || isset($row->quiz)) {echo base_URL()."user/update_q";} else { echo base_URL()."user/add_q//";}?>"method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <?php
                                                        ...
                                                        echo "<label><input name='quiz' value='1' type='radio' class='ace'";
                                                        if ($row->quiz == 1) { echo "checked";} else {}
                                                        echo "><span class='lbl'> $row->option_1</span></label><br>";

                                                        echo "<label><input name='quiz' value='2' type='radio' class='ace'";
                                                        if ($row->quiz == 2) { echo "checked";} else {}
                                                        echo "><span class='lbl'> $row->option_2</span></label><br>";

                                                        echo "<label><input name='quiz' value='3' type='radio' class='ace'";
                                                        if ($row->quiz == 3) { echo "checked";} else {}
                                                        echo "><span class='lbl'> $row->option_3</span></label><br>";

                                                        echo "<label><input name='quiz' value='4' type='radio' class='ace'";
                                                        if ($row->quiz == 4) { echo "checked";} else {}
                                                        echo "><span class='lbl'> $row->option_4</span></label><br>";

                                                            if (empty($row->option_5)) {
                                                            } else {
                                                                echo "<label><input name='quiz' value='5' type='radio' class='ace'";
                                                                if ($row->quiz == 5) { echo "checked";} else {}
                                                                echo "><span class='lbl'> $row->option_5</span></label><br>";
                                                            }
                                                            if (empty($row->option_6)) {
                                                            } else {
                                                                echo "<label><input name='quiz' value='6' type='radio' class='ace'";
                                                                if ($row->quiz == 6) { echo "checked";} else {}
                                                                echo "><span class='lbl'> $row->option_6</span></label><br>";
                                                            }
                                                        echo "</div>";
                                                    ?>
