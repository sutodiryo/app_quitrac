...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - Quick Traceability Assessment</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Quick Traceability</span>
									<span class="white" id="id-text2">Assessment</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; UNS</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="center header blue lighter bigger">
												<i class="ace-icon fa fa-key green"></i>
												Login User
											</h4>
											<?php echo $this->session->flashdata('error_report');?>
